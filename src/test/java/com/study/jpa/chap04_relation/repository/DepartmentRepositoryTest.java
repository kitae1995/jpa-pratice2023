...
class DepartmentRepositoryTest {
    ...
    //엔터티들을 관리하는 역할을 수행하는 클래스 (.영속성 컨테스트를 관리함 )
    //영속성 컨테스트 내의 내용들을 DB에 반영시키거나 비워내거나 수명을 관리할 수 있음
    @Autowired
...
//        foundEmp.getDepartment(); 3번부서
        ...
        //1번 방법
        //변경 감지 후 변경된 내용을 즉시 반영
        //save는 어디다가 쓰던 함수 마지막에 실행되기때문에 이렇게 작성해줘야 중간에 진행함
